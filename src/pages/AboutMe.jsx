    ...
    <main id="aboutme" className="opacity-100 transition-all duration-300 mb-20">
      ...
      <section className="w-11/12 rounded mx-auto flex p-5">
        <article className="w-6/12 p-5">
          <h5 className="text-2xl font-bold text-center">About me</h5>
          <p className="text-md indent-10 mb-2 text-justify leading-6 mt-8">
          ...
          <p className="text-md indent-10 text-justify leading-6">
        ...
        <article className="w-6/12 p-5">
          <h5 className="text-2xl font-bold text-center">Languages and Dev Tools</h5>
          <aside className="grid text-center align-baseline w-11/12 mx-auto mt-8 grid-cols-5 gap-6">
            {Languages.map((lang, i) => (
              <aside key={i} className="flex flex-col justify-center align-middle">
                ...
                />
                <p className="w-full text-sm font-semibold">{lang.name}</p>
              </aside>
            ))}
          </aside>
        </article>
