...
export const Works = () => {
  return (
    ...
    >
      <article className="w-6/12 mb-5 p-8 relative left-0">
        <img
          src={homeborIcon}
          alt=""
        ...
        <aside className="bg-white shadow-md p-5 rounded-md">
          <h2 className="text-2xl font-semibold mb-1">Plataforma Homebor</h2>
          <h3 className="text-md font-semibold mb-1">Desarrollador Frontend - Desarrollador Backend </h3>
          <h5 className="text-md text-slate-700 mb-5">2020 - 2023</h5>
      ...
      <article className="w-6/12 mb-5 p-8 relative left-2/4">
        ...
        <aside className="bg-white shadow-md p-4 rounded-md">
          <h2 className="text-2xl font-semibold mb-1">Centro Nacional de Tecnologías de Información</h2>
          <h3 className="text-md font-semibold mb-1">Desarrollador</h3>
          <h5 className="text-md text-slate-700 mb-5">2019 - 2020</h5>
          <p className="text-lg text-justify">
